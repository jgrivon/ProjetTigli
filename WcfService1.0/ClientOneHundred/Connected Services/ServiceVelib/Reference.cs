...
namespace ClientOneHundred.ServiceVelib {
    ...
    public interface IVelibService {
        ...
        long CalculTrajectory(ClientOneHundred.ServiceVelib.Coordinates departure, ClientOneHundred.ServiceVelib.Coordinates destination);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IVelibService/CalculTrajectory", ReplyAction="http://tempuri.org/IVelibService/CalculTrajectoryResponse")]
        System.Threading.Tasks.Task<long> CalculTrajectoryAsync(ClientOneHundred.ServiceVelib.Coordinates departure, ClientOneHundred.ServiceVelib.Coordinates destination);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IVelibServiceChannel : ClientOneHundred.ServiceVelib.IVelibService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class VelibServiceClient : System.ServiceModel.ClientBase<ClientOneHundred.ServiceVelib.IVelibService>, ClientOneHundred.ServiceVelib.IVelibService {
        ...
        public long CalculTrajectory(ClientOneHundred.ServiceVelib.Coordinates departure, ClientOneHundred.ServiceVelib.Coordinates destination) {
            return base.Channel.CalculTrajectory(departure, destination);
        }
        
        public System.Threading.Tasks.Task<long> CalculTrajectoryAsync(ClientOneHundred.ServiceVelib.Coordinates departure, ClientOneHundred.ServiceVelib.Coordinates destination) {
